...
public class data {
    ...
    public static String[] limbo=new String[]{"罪人 被折磨的灵魂","屠夫 腐肉","镰刃行刑官 被折磨的灵魂",
    ...
    public static String[] barrenPlain=new String[]{"火蝇 火鳞","火蜥蜴 火蜥蜴的蛋","枯树 枯树枝","枯骨 骨片"
            ,"秃鹫 厚重羽毛","毒蛇 毒腺","野狗 狗牙","小豹子 豹子皮","成年雄狮 狮皮","田鼠 鼠皮","被诅咒的稻草人 诅咒印记"};
    ...
    private static String[][] clericEquipment=new String[][]{"轻质头盔.10 铁头盔.20 祝福头盔.30 荣耀头盔.40 信仰盔.50".split(" "),
            "木制盾牌.10 铁盾牌.20 小圆盾.30 突刺盾.40 祝福盾牌.50 信仰盾.60".split(" "),
            "硬头锤.10 单手斧.20 信仰短刃.30 祝福锤.40 十字锤.50 亡语者.60 奇迹短刃.70 制裁者.80".split(" "),
    ...
    private static String[][] paladinEquipment=new String[][]{"轻质头盔.10 铁头盔.20 祝福头盔.30 荣耀头盔.40 信仰盔.50 圣光盔.60 圣武士战盔.70".split(" "),
            ...
            "护戒.10 祝福戒指.20 宁静戒指.30 灵狐戒指.40 蓝石戒指.50 惜别戒指6 阳光戒.70".split(" "),
